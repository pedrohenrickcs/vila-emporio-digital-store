          ...
          <div className="md:col-span-1">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Seu mercadinho de bairro</p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                <MapPin className="h-4 w-4 text-orange-400 mr-2 flex-shrink-0" />
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300 text-sm">contato@emporiodavila.com.br</span>
              </div>
              <div className="flex items-start">
                <Clock className="h-4 w-4 text-orange-400 mr-2 mt-0.5 flex-shrink-0" />
